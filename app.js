...
window._eigoPetInit = function() {
  ...
  var state = (function(){
    ...
    if(s.moneyTiersV!==4 || !Array.isArray(s.moneyTiers) || !s.moneyTiers.length){
      s.moneyTiers=[{cap:100,rate:5},{cap:150,rate:7},{cap:200,rate:8},{cap:250,rate:9},{cap:300,rate:10}];
      s.moneyTiersV=4;
    }
  ...
  var DEFAULT_TIERS=[{cap:100,rate:5},{cap:150,rate:7},{cap:200,rate:8},{cap:250,rate:9},{cap:300,rate:10}];
